...
class BinarySearchTree {
  ...
  toArrLevelorder(current = this.root) {
    let vals = []; //FINAL RETURN
    let newVals = []; //STAGING THE ARRAY
    ...
    //utilizing recursion - push current into newVal
    if (current) {
    ...
    while (newVals.length > 0) {
      let whileVals = newVals.shift(); //BUILT IN - removes first from array and returns it
      ...
      //push next left into array
      //push next right into array
      //determine new current left and push && new current right and push
      //determine new current Right and push && new current right and push
    }
    return vals;
  }
   ...
   */
  size(node = this.root) {
    //lists out all nodes in the tree - those are placed into an array, then
    let nodes = this.toArrPreorder();
    //return nodes.length giving us the number of nodes that were in the array == the total number of node in the tree
    return nodes.length;
  }
...
console.log("===TEST CASE ============(toArrLevelorder)===========");
threeLevelTree.print();
console.log("=Answer=");
console.log(threeLevelTree.toArrLevelorder());

console.log("===TEST CASE ============(size)===========");
threeLevelTree.print();
console.log("=Answer=");
console.log(threeLevelTree.size());

console.log("===TEST CASE ============(height)===========");
threeLevelTree.print();
console.log("=Answer=");
console.log(threeLevelTree.height());


console.log("===TEST CASE ============(isFull)===========");
threeLevelTree.print();
console.log("=Answer=");
